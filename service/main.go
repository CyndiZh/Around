...
const (
	...
	ES_URL = "http://35.224.80.221:9200"
	BUCKET_NAME = "post-images-203921-1707123"
	API_PREFIX = "/api/v1" // If deploy together with frontend.
)
...
func handlerPost(w http.ResponseWriter, r *http.Request) {
	...
	id := uuid.New()
	// read image from response and save to "file" inorder to save to GCS
	...
	// read image from response and save to annotation
...
func saveToGCS(ctx context.Context, r io.Reader, bucketName, name string) (*storage.ObjectHandle, *storage.ObjectAttrs, error) {
	client, err := storage.NewClient(ctx);	// storage?
...
func handlerCluster(w http.ResponseWriter, r *http.Request) {
	...
	// "term" reservced for future potencial bucketings
